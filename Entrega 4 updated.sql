...
BEGIN
    FOR k IN 1..IND LOOP
        FOR i IN (
           SELECT SUM(TarjetaRoja+TarjetaAmarilla1+TarjetaAmarilla2) AS Amonestaciones, 
            c.Nombre AS Club,
            c.Presupuesto AS Presupuesto,
            p.Id_partido AS Partido
            FROM Partido_objtab p, TABLE(p.jugadores) pj, Jugador_objtab j,Equipo_objtab e, Club_objtab c
            WHERE p.Id_partido = V_ID(k) AND
                pj.Jugador = REF(j) AND
                j.Equipo = p.Equipo_visitante AND
                p.Equipo_visitante = REF(e) AND
                e.Club = REF(c) 
            GROUP BY c.Nombre, c.Presupuesto, p.Id_partido
        ) LOOP
            V_Presupuesto := i.presupuesto;
            IF ((V_Presupuesto - (100*i.Amonestaciones)) >= 0) THEN
                UPDATE club_objtab c
                SET c.presupuesto = (c.presupuesto - (100*i.Amonestaciones))
        ...
        FOR j IN (
            ...
            c.Nombre AS Club,
            c.Presupuesto AS Presupuesto,
            p.Id_partido AS ID_patido
            FROM Partido_objtab p, TABLE(p.jugadores) pj, Jugador_objtab j,Equipo_objtab e, Club_objtab c
            WHERE p.Id_partido = V_ID(k) AND
                pj.Jugador = REF(j) AND
                j.Equipo = p.Equipo_local AND
                p.Equipo_local = REF(e) AND
                e.Club = REF(c) 
            GROUP BY c.Nombre, c.Presupuesto, p.Id_partido
            ) LOOP
                V_Presupuesto := j.presupuesto;
                IF ((V_Presupuesto - (100*j.Amonestaciones)) >= 0) THEN
                    UPDATE club_objtab c
                    SET c.presupuesto = (c.presupuesto - (100*j.Amonestaciones))
                    WHERE c.Nombre = j.Club;               
                END IF;
        END LOOP;
    END LOOP;
END AFTER STATEMENT;
...
INSERT INTO Partido_objtab (ID_partido, Fecha, Hora, Equipo_local, Equipo_visitante, Estadio_partido, jugadores, arbitros)
    VALUES (100, SYSDATE, 16,
            ...
            (SELECT REF (e) FROM Estadio_objtab e WHERE e.Nombre = 'Spotify Camp Nou'),
            nt_juega_typ(
                        Juega_objtyp(0, null, 1, 0, 0, 23, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 100)),
                        Juega_objtyp(0, null, 1, 0, 0, 11, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 101)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 102)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 103)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 104)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 105)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 106)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 107)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 5, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 108)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 1, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 109)),
                        Juega_objtyp(0, 60, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 110)),
                        Juega_objtyp(60, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j  WHERE j.Id_persona = 111)),
            ...
            nt_arbitra_typ(
                        Arbitra_objtyp('Principal', (SELECT REF(a) FROM Arbitro_objtab A WHERE a.Id_persona = 2)),
                        Arbitra_objtyp('Asistente adicional', (SELECT REF(a) FROM Arbitro_objtab A WHERE a.Id_persona = 1)),
                        Arbitra_objtyp('Asistente', (SELECT REF(a) FROM Arbitro_objtab A WHERE a.Id_persona = 3)),
                        Arbitra_objtyp('Cuarto', (SELECT REF(a) FROM Arbitro_objtab A WHERE a.Id_persona = 4))
            ));/

UPDATE Partido_objtab
SET Resultado = (Resultado_objtyp(5, 6, (SELECT REF(j) FROM Jugador_objtab j WHERE j.ID_persona = 200), 46, 46))
WHERE ID_Partido = 100;
/


INSERT INTO Partido_objtab (ID_partido, Fecha, Hora, Equipo_local, Equipo_visitante, Estadio_partido, jugadores, arbitros)
    VALUES (103, SYSDATE, 13,
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'FC Barcelona'),
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'Atlético de Madrid'),
            (SELECT REF (e) FROM Estadio_objtab e WHERE e.Nombre = 'Spotify Camp Nou'),
...
UPDATE Partido_objtab
SET Resultado = (Resultado_objtyp(1, 1, (SELECT REF(j) FROM Jugador_objtab j WHERE j.ID_persona = 301), 46, 46))
WHERE ID_Partido = 103;
/

INSERT INTO Partido_objtab (ID_partido, Fecha, Hora, Equipo_local, Equipo_visitante, Estadio_partido, jugadores, arbitros)
    VALUES (104, SYSDATE, 12,
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'Real Madrid CF'),
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'Atlético de Madrid'),
            (SELECT REF (e) FROM Estadio_objtab e WHERE e.Nombre = 'Santiago Bernabéu'),
...
INSERT INTO Partido_objtab (ID_partido, Fecha, Hora, Equipo_local, Equipo_visitante, Estadio_partido, jugadores, arbitros)
    VALUES (105, SYSDATE, 21,
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'Real Madrid CF'),
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'FC Barcelona'),
            (SELECT REF (e) FROM Estadio_objtab e WHERE e.Nombre = 'Santiago Bernabéu'),
  
            nt_juega_typ(
                        Juega_objtyp(0, null, 1, 0, 0, 23, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 200)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 201)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 202)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 2, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 203)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 1, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 204)),
                        ...
                        Juega_objtyp(0, null, 1, 0, 0, 33, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 100)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 101)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 102)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 103)),
                        Juega_objtyp(0, null, 1, 0, 0, 83, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 104)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 105)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 106)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 107)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 10, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 108)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 109)),
                        Juega_objtyp(0, 45, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 110)),
                        Juega_objtyp(45, null, 0, 0, 0, null, null, null, 1, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 111))
            ),
            nt_arbitra_typ(
                        Arbitra_objtyp('Principal', (SELECT REF(a) FROM Arbitro_objtab A WHERE Id_persona = 5)),
                        Arbitra_objtyp('Asistente adicional', (SELECT REF(a) FROM Arbitro_objtab A WHERE a.Id_persona = 1)),
                        Arbitra_objtyp('Asistente', (SELECT REF(a) FROM Arbitro_objtab A WHERE a.Id_persona = 3)),
                        Arbitra_objtyp('Cuarto', (SELECT REF(a) FROM Arbitro_objtab A WHERE a.Id_persona = 4))
            ));/
...
UPDATE Partido_objtab
SET Resultado = (Resultado_objtyp(11, 5, (SELECT REF(j) FROM Jugador_objtab j WHERE j.ID_persona = 108), 46, 46))
WHERE ID_Partido = 105;
/

INSERT INTO Partido_objtab (ID_partido, Fecha, Hora, Equipo_local, Equipo_visitante, Estadio_partido, jugadores, arbitros)
    VALUES (106, SYSDATE, 21,
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'Real Madrid CF'),
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'FC Barcelona'),
            (SELECT REF (e) FROM Estadio_objtab e WHERE e.Nombre = 'Santiago Bernabéu'),
...
UPDATE Partido_objtab
SET Resultado = (Resultado_objtyp(11, 1, (SELECT REF(j) FROM Jugador_objtab j WHERE j.ID_persona = 108), 46, 46))
WHERE ID_Partido = 106;
/

INSERT INTO Partido_objtab (ID_partido, Fecha, Hora, Equipo_local, Equipo_visitante, Estadio_partido, jugadores, arbitros)
    VALUES (107, SYSDATE, 13,
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'FC Barcelona'),
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'Atlético de Madrid'),
            (SELECT REF (e) FROM Estadio_objtab e WHERE e.Nombre = 'Spotify Camp Nou'),
            ...
            nt_juega_typ(
                        ...
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 203)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 204)),
                        Juega_objtyp(0, null, 1, 0, 0, 21, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 205)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 206)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 207)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 208)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 209)),
            ...
            nt_arbitra_typ(
                        Arbitra_objtyp('Principal', (SELECT REF(a) FROM Arbitro_objtab A WHERE a.Id_persona = 5)),
                        Arbitra_objtyp('Asistente adicional', (SELECT REF(a) FROM Arbitro_objtab A WHERE a.Id_persona = 2)),
                        Arbitra_objtyp('Asistente', (SELECT REF(a) FROM Arbitro_objtab A WHERE a.Id_persona = 3)),
                        Arbitra_objtyp('Cuarto', (SELECT REF(a) FROM Arbitro_objtab A WHERE a.Id_persona = 4))
            ));/
...
INSERT INTO Partido_objtab (ID_partido, Fecha, Hora, Equipo_local, Equipo_visitante, Estadio_partido, jugadores, arbitros)
    VALUES (108, SYSDATE, 13,
            ...
            nt_juega_typ(
                        Juega_objtyp(0, null, 1, 1, 1, 23, 5, 23, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 200)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 10, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 201)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 202)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 203)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 204)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 205)),
                        ...
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 1, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 309)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 310)),
                        Juega_objtyp(60, null, 1, 0, 0, 83, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 311))
...
UPDATE Partido_objtab
SET Resultado = (Resultado_objtyp(11, 1, (SELECT REF(j) FROM Jugador_objtab j WHERE j.ID_persona = 201), 46, 46))
WHERE ID_Partido = 108;
/

INSERT INTO Partido_objtab (ID_partido, Fecha, Hora, Equipo_local, Equipo_visitante, Estadio_partido, jugadores, arbitros)
    VALUES (109, SYSDATE, 13,
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'FC Barcelona'),
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'Atlético de Madrid'),
            (SELECT REF (e) FROM Estadio_objtab e WHERE e.Nombre = 'Spotify Camp Nou'),
  
            nt_juega_typ(
                        Juega_objtyp(0, null, 1, 1, 1, 25, 12, 25, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 200)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, 23, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 201)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 202)),
                        Juega_objtyp(0, null, 0, 0, 1, null, null, 43, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 203)),
                        Juega_objtyp(0, null, 1, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 204)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 205)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 206)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 207)),
                        Juega_objtyp(0, null, 0, 0, 0, null, null, null, 0, (SELECT REF(j) FROM Jugador_objtab j WHERE j.Id_persona = 208)),
...
UPDATE Partido_objtab
SET Resultado = (Resultado_objtyp(1, 1, (SELECT REF(j) FROM Jugador_objtab j WHERE j.ID_persona = 309), 46, 46))
...
WHERE p.Estadio_partido = REF(es) 
...
DEREF(p.Estadio_partido).Nombre AS Estadio, p.Fecha
FROM Partido_objtab p, TABLE(p.jugadores) pj, Jugador_objtab j
WHERE pj.Jugador = REF(j)
...
CREATE OR REPLACE PROCEDURE Clasificacion_temporada2(vdivision IN LigaFutbol_objtab.Division%TYPE, vpais IN Pais_objtab.nombre%TYPE)
IS
    ...
    CURSOR c_resultado_local(Nombre_equipo Equipo_objtab.nombre%type) IS (
        SELECT p.Resultado.GolesLocal AS GolesLocal, p.Resultado.GolesVisitante AS GolesVisitante, DEREF(Equipo_visitante).Nombre AS EquipoVisitante
    ...
    CURSOR c_resultado_visitante(Nombre_equipo Equipo_objtab.nombre%type) IS (
        SELECT p.Resultado.GolesLocal AS GolesLocal, p.Resultado.GolesVisitante AS GolesVisitante, DEREF(Equipo_local).Nombre AS EquipoLocal
        FROM Partido_objtab p, Equipo_objtab e 
...
BEGIN
    IF vdivision IS null AND vpais IS NULL THEN 
        RAISE_APPLICATION_ERROR(-20012, 'Los parámetros introducidos no son validos');
    END IF;
    ...
    FOR I IN 1..TEquipos.COUNT LOOP
        ...
        FOR v_partido IN c_resultado_local(VNombre) LOOP
            DBMS_OUTPUT.PUT_LINE('-------->' || VNombre || ' CONTRA ' || v_partido.EquipoVisitante || ':' || v_partido.GolesLocal || '-' || v_partido.GolesVisitante || '<--------');
        END LOOP; 
        ...
        FOR v_partido IN c_resultado_visitante(VNombre) LOOP
            DBMS_OUTPUT.PUT_LINE('-------->' || VNombre || ' CONTRA ' || v_partido.EquipoLocal || ':' || v_partido.GolesVisitante || '-' || v_partido.GolesLocal || '<--------');
        END LOOP; 
...
FOR INSERT OR UPDATE OF Equipo ON Jugador_objtab
COMPOUND TRIGGER
    
    TYPE T_Equipo IS TABLE OF Jugador_objtab.Equipo%TYPE INDEX BY BINARY_INTEGER;
    VT_Equipo T_Equipo;
    TYPE T_Historial IS TABLE OF Jugador_objtab.Historial%TYPE INDEX BY BINARY_INTEGER;
    VT_Historial T_Historial;
    TYPE T_Id IS TABLE OF Jugador_objtab.Id_persona%TYPE INDEX BY BINARY_INTEGER;
    VT_Id T_Id;
    ...
    v_old_id_historial Historial_objtab.Id_historial%TYPE;
    v_equipo Jugador_objtab.Equipo%TYPE;
    v_anio NUMBER;
    v_mes NUMBER;
    
    v_equipo_anterior Jugador_objtab.Equipo%TYPE;
    
BEFORE EACH ROW IS
BEGIN
    IND := IND + 1;
    VT_Equipo(IND) := :NEW.Equipo;
    VT_Historial(IND) := :NEW.Historial;
    VT_Id(IND) := :NEW.Id_persona;
    v_equipo_anterior := :OLD.Equipo;
END BEFORE EACH ROW;
...
BEGIN
    ...
    FOR i IN 1..IND LOOP
        ...
        FROM Jugador_objtab j
        WHERE j.Equipo = VT_Equipo(i)
        AND j.Historial.TemporadaSalida IS NULL; --Por si hubiera registrado algún jugador que ya haya salido del equipo
        ...
        --Calculo el id que le voy a asignar a su historial
        SELECT MAX(id_historial) + 1 INTO v_id_historial FROM Historial_objtab;
        IF v_id_historial IS NULL THEN
            v_id_historial := 1;
        END IF;
        
        --Creo el historial que va a ir asociado al jugador
        INSERT INTO Historial_objtab (id_historial, equipo, temporadaentrada)
        VALUES (v_id_historial, VT_Equipo(i), v_temporada);
        
        SELECT REF(h) INTO VT_Historial(i) FROM Historial_objtab h WHERE h.id_historial = v_id_historial;
            
        IF UPDATING THEN 
            IF VT_Equipo(i) != v_equipo_anterior THEN
            --Actualizo su antiguo historial
                    
            SELECT j.Historial.id_historial INTO v_old_id_historial
            FROM Jugador_objtab j
            WHERE j.Id_persona = VT_Id(i);
            
            IF v_old_id_historial IS NOT NULL THEN
                UPDATE Historial_objtab h
                SET h.TemporadaSalida = v_temporada
                WHERE h.id_historial = v_old_id_historial;
            END IF;
            
            UPDATE Jugador_objtab j
            SET j.Historial = VT_Historial(i)
            WHERE j.Id_persona = VT_Id(i);
            
            ELSE 
                DELETE Historial_objtab
                WHERE Id_historial = v_id_historial;
            END IF;
        
        ELSIF INSERTING THEN
            -- asigno su nuevo historial    
            UPDATE Jugador_objtab j
            SET j.Historial = VT_Historial(i)
            WHERE j.Id_persona = VT_Id(i);
        END IF;  
...
INSERT INTO Jugador_objtab (ID_persona, Nombre, Apellido1, Apellido2, Edad, Pais, Dorsal, Posicion, Sueldo, Equipo, TarjetasRojas, TarjetasAmarillas, PartidosJugados, MinutosJugados, GolesTotales)
    VALUES(1100, 'Mounty', 'Tern', 'Alves', 23, (SELECT REF(p) FROM Pais_objtab p WHERE p.Nombre = 'Portugal'), 20, 'Delantero', 7000000,
    (SELECT REF(e) FROM equipo_objtab e WHERE e.nombre like 'Atlético de Madrid'), 0, 0, 0, 0, 0
);/
-- Actualizar jugador (NO EQUIPO) -> no se cambia su historial
UPDATE Jugador_objtab
SET Dorsal = 13
WHERE id_persona = 1100;/
-- Actuailizar jugador (MISMO EQUIPO) -> no se cambia su historial
UPDATE Jugador_objtab
...
from jugador_objtab j
where j.equipo.nombre = 'Liverpool'
GROUP BY j.equipo;


INSERT INTO Jugador_objtab (ID_persona, Nombre, Apellido1, Apellido2, Edad, Pais, Dorsal, Posicion, Sueldo, Equipo, TarjetasRojas, TarjetasAmarillas, PartidosJugados, MinutosJugados, GolesTotales)
    VALUES(1101, 'Rafa', 'Tox', 'Lins', 23, (SELECT REF(p) FROM Pais_objtab p WHERE p.Nombre = 'Portugal'), 20, 'Delantero', 7000000,
    (SELECT REF(e) FROM equipo_objtab e WHERE e.nombre like 'Liverpool'), 0, 0, 0, 0, 0
);/

INSERT INTO Jugador_objtab (ID_persona, Nombre, Apellido1, Apellido2, Edad, Pais, Dorsal, Posicion, Sueldo, Equipo, TarjetasRojas, TarjetasAmarillas, PartidosJugados, MinutosJugados, GolesTotales)
    VALUES(1102, 'Klen', 'Pasz', 'Reus', 23, (SELECT REF(p) FROM Pais_objtab p WHERE p.Nombre = 'Portugal'), 20, 'Delantero', 7000000,
    (SELECT REF(e) FROM equipo_objtab e WHERE e.nombre like 'Liverpool'), 0, 0, 0, 0, 0
);/

INSERT INTO Jugador_objtab (ID_persona, Nombre, Apellido1, Apellido2, Edad, Pais, Dorsal, Posicion, Sueldo, Equipo, TarjetasRojas, TarjetasAmarillas, PartidosJugados, MinutosJugados, GolesTotales)
    VALUES(1103, 'Cristian', 'Gonza', 'Leza', 23, (SELECT REF(p) FROM Pais_objtab p WHERE p.Nombre = 'Portugal'), 20, 'Delantero', 7000000,
    (SELECT REF(e) FROM equipo_objtab e WHERE e.nombre like 'Liverpool'), 0, 0, 0, 0, 0
);/

INSERT INTO Jugador_objtab (ID_persona, Nombre, Apellido1, Apellido2, Edad, Pais, Dorsal, Posicion, Sueldo, Equipo, TarjetasRojas, TarjetasAmarillas, PartidosJugados, MinutosJugados, GolesTotales)
    VALUES(1104, 'Paulino', 'Torres', 'Alicn', 23, (SELECT REF(p) FROM Pais_objtab p WHERE p.Nombre = 'Portugal'), 20, 'Delantero', 7000000,
    (SELECT REF(e) FROM equipo_objtab e WHERE e.nombre like 'Liverpool'), 0, 0, 0, 0, 0
);/

INSERT INTO Jugador_objtab (ID_persona, Nombre, Apellido1, Apellido2, Edad, Pais, Dorsal, Posicion, Sueldo, Equipo, TarjetasRojas, TarjetasAmarillas, PartidosJugados, MinutosJugados, GolesTotales)
    VALUES(1105, 'Sergio', 'Ramas', 'Seco', 23, (SELECT REF(p) FROM Pais_objtab p WHERE p.Nombre = 'Portugal'), 20, 'Delantero', 7000000,
    (SELECT REF(e) FROM equipo_objtab e WHERE e.nombre like 'Liverpool'), 0, 0, 0, 0, 0
);/

INSERT INTO Jugador_objtab (ID_persona, Nombre, Apellido1, Apellido2, Edad, Pais, Dorsal, Posicion, Sueldo, Equipo, TarjetasRojas, TarjetasAmarillas, PartidosJugados, MinutosJugados, GolesTotales)
    VALUES(1106, 'Roberto', 'Wido', 'Wido', 23, (SELECT REF(p) FROM Pais_objtab p WHERE p.Nombre = 'Portugal'), 20, 'Delantero', 7000000,
    (SELECT REF(e) FROM equipo_objtab e WHERE e.nombre like 'Liverpool'), 0, 0, 0, 0, 0
);/

INSERT INTO Jugador_objtab (ID_persona, Nombre, Apellido1, Apellido2, Edad, Pais, Dorsal, Posicion, Sueldo, Equipo, TarjetasRojas, TarjetasAmarillas, PartidosJugados, MinutosJugados, GolesTotales)
    VALUES(1107, 'Alberto', 'San', 'Tint', 23, (SELECT REF(p) FROM Pais_objtab p WHERE p.Nombre = 'Portugal'), 20, 'Delantero', 7000000,
    (SELECT REF(e) FROM equipo_objtab e WHERE e.nombre like 'Liverpool'), 0, 0, 0, 0, 0
);/

INSERT INTO Jugador_objtab (ID_persona, Nombre, Apellido1, Apellido2, Edad, Pais, Dorsal, Posicion, Sueldo, Equipo, TarjetasRojas, TarjetasAmarillas, PartidosJugados, MinutosJugados, GolesTotales)
    VALUES(1108, 'Fernando', 'Alonso', 'Diaz', 23, (SELECT REF(p) FROM Pais_objtab p WHERE p.Nombre = 'Portugal'), 20, 'Delantero', 7000000,
    (SELECT REF(e) FROM equipo_objtab e WHERE e.nombre like 'Liverpool'), 0, 0, 0, 0, 0
);/

INSERT INTO Jugador_objtab (ID_persona, Nombre, Apellido1, Apellido2, Edad, Pais, Dorsal, Posicion, Sueldo, Equipo, TarjetasRojas, TarjetasAmarillas, PartidosJugados, MinutosJugados, GolesTotales)
    VALUES(1109, 'Gesus', 'Torin', 'Pall', 23, (SELECT REF(p) FROM Pais_objtab p WHERE p.Nombre = 'Portugal'), 20, 'Delantero', 7000000,
    (SELECT REF(e) FROM equipo_objtab e WHERE e.nombre like 'Liverpool'), 0, 0, 0, 0, 0
);/

INSERT INTO Jugador_objtab (ID_persona, Nombre, Apellido1, Apellido2, Edad, Pais, Dorsal, Posicion, Sueldo, Equipo, TarjetasRojas, TarjetasAmarillas, PartidosJugados, MinutosJugados, GolesTotales)
    VALUES(1110, 'Xin', 'Zhao', 'Perez', 23, (SELECT REF(p) FROM Pais_objtab p WHERE p.Nombre = 'Portugal'), 20, 'Delantero', 7000000,
    (SELECT REF(e) FROM equipo_objtab e WHERE e.nombre like 'Liverpool'), 0, 0, 0, 0, 0
);/

INSERT INTO Jugador_objtab (ID_persona, Nombre, Apellido1, Apellido2, Edad, Pais, Dorsal, Posicion, Sueldo, Equipo, TarjetasRojas, TarjetasAmarillas, PartidosJugados, MinutosJugados, GolesTotales)
    VALUES(1111, 'Garen', 'De', 'Lamo', 23, (SELECT REF(p) FROM Pais_objtab p WHERE p.Nombre = 'Portugal'), 20, 'Delantero', 7000000,
    (SELECT REF(e) FROM equipo_objtab e WHERE e.nombre like 'Liverpool'), 0, 0, 0, 0, 0
);/


INSERT INTO Jugador_objtab (ID_persona, Nombre, Apellido1, Apellido2, Edad, Pais, Dorsal, Posicion, Sueldo, Equipo, TarjetasRojas, TarjetasAmarillas, PartidosJugados, MinutosJugados, GolesTotales)
    VALUES(1112, 'Gabriel', 'Jesust', 'Lima', 23, (SELECT REF(p) FROM Pais_objtab p WHERE p.Nombre = 'Portugal'), 20, 'Delantero', 7000000,
    (SELECT REF(e) FROM equipo_objtab e WHERE e.nombre like 'Liverpool'), 0, 0, 0, 0, 0
);/

--Error: El equipo no puede inscribir más jugadores a la liga
INSERT INTO Jugador_objtab (ID_persona, Nombre, Apellido1, Apellido2, Edad, Pais, Dorsal, Posicion, Sueldo, Equipo, TarjetasRojas, TarjetasAmarillas, PartidosJugados, MinutosJugados, GolesTotales)
    VALUES(1113, 'Lewis', 'Hamilton', 'Agin', 23, (SELECT REF(p) FROM Pais_objtab p WHERE p.Nombre = 'Portugal'), 20, 'Delantero', 7000000,
    (SELECT REF(e) FROM equipo_objtab e WHERE e.nombre like 'Liverpool'), 0, 0, 0, 0, 0
);/
...
-- Se cambia la fecha: 28/06/23 - 16h --> 29/06/23 - 16h.
INSERT INTO Partido_objtab (ID_partido, Fecha, Hora, Equipo_local, Equipo_visitante, Estadio_partido, jugadores, arbitros)
    VALUES (201, '28/06/23', 16,
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'FC Barcelona'),
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'Real Madrid CF'),
            (SELECT REF (e) FROM Estadio_objtab e WHERE e.Nombre = 'Santiago Bernabéu'),
            nt_juega_typ(
...
-- Se cambia la fecha: 28/06/23 - 16h --> 30/06/23 - 16h.
INSERT INTO Partido_objtab (ID_partido, Fecha, Hora, Equipo_local, Equipo_visitante, Estadio_partido, jugadores, arbitros)
    VALUES (202, '28/06/23', 16,
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'FC Barcelona'),
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'Real Madrid CF'),
            (SELECT REF (e) FROM Estadio_objtab e WHERE e.Nombre = 'Santiago Bernabéu'),
            nt_juega_typ(
...
-- Se cambia la fecha: 28/06/23 - 16h --> 01/07/23 - 16h.            
INSERT INTO Partido_objtab (ID_partido, Fecha, Hora, Equipo_local, Equipo_visitante, Estadio_partido, jugadores, arbitros)
    VALUES (203, '28/06/23', 16,
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'FC Barcelona'),
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'Real Madrid CF'),
            (SELECT REF (e) FROM Estadio_objtab e WHERE e.Nombre = 'Santiago Bernabéu'),
            nt_juega_typ(
...
-- No se cambia la fecha, ya que el partido es en el camp nou y no había ningún partido programado en esa fecha.    
INSERT INTO Partido_objtab (ID_partido, Fecha, Hora, Equipo_local, Equipo_visitante, Estadio_partido, jugadores, arbitros)
    VALUES (204, '28/06/23', 16,
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'FC Barcelona'),
            (SELECT REF(e) FROM Equipo_objtab e WHERE e.Nombre = 'Real Madrid CF'),
            (SELECT REF (e) FROM Estadio_objtab e WHERE e.Nombre = 'Spotify Camp Nou'),
            nt_juega_typ(
...
--(ya que ahora se juega en el Santiago bernabeu, y esa fecha ya estaba ocupada: la más próxima es el 2 de julio)          
UPDATE Partido_objtab
...
WHERE XMLExists('/sudaderas/sudadera[color="Azul marino" or color="Rojo"]' PASSING p.sudadera);/
...
STORE AS BINARY XML
XMLSCHEMA "http://xmlns.oracle.com/xdb/schemas/DBDD_42/camisetas.xsd"
ELEMENT "camisetas";
/
--------------------------------------------
